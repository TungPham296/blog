    ...
    <aside class="left-sidebar">
        ...
        <div>
            <div class="brand-logo d-flex align-items-center justify-content-between">
                <NuxtLink to="/admin" class="text-nowrap logo-img">
                    <img
                        src="assets/admin/images/logos/dark-logo.svg"
                        width="180"
                        alt=""
                    />
                </NuxtLink>
            ...
            <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item">
                        <NuxtLink to="/admin" class="sidebar-link" aria-expanded="false">
                            <span>
                    ...
                    <li class="sidebar-item">
                        <NuxtLink to="/admin/categories" class="sidebar-link" aria-expanded="false">
                            <span>
                    ...
                    <li class="sidebar-item">
                        <NuxtLink to="/admin/products" class="sidebar-link" aria-expanded="false">
                            <span>
                ...
                >
                    <div class="d-flex">
                        ...
                        <div class="unlimited-access-img">
                            <img
                                src="assets/admin/images/backgrounds/rocket.png"
                                alt=""
                                class="img-fluid"
                            />
                        </div>
