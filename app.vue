...
let width = computed(() => !loadingStore.value ? 0 : ((totalRequest.value - loadingStore.value) / totalRequest.value) * 100)

watch(loadingStore, (loadingStore) => {
    totalRequest.value = loadingStore >= totalRequest.value ? loadingStore : loadingStore === 0 ? loadingStore : totalRequest.value
});
